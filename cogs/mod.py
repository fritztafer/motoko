...
class Mod(commands.Cog):
    ...
    @decorators.sync()
    async def ban(self, ctx: commands.Context[Motoko], user: Member, *, reason: str | None):
    ...
    @commands.has_permissions(ban_members=True)
    @decorators.sync()
    async def unban(self, ctx: commands.Context[Motoko], user: User, *, reason: str | None):
        if ctx.guild:
    ...
    @commands.has_permissions(ban_members=True)
    @decorators.sync()
    async def softban(self, ctx: commands.Context[Motoko], user: Member, *, reason: str | None):
    ...
    @commands.has_permissions(ban_members=True)
    @decorators.sync()
    async def kick(self, ctx: commands.Context[Motoko], user: Member, *, reason: str | None):
    ...
    @commands.has_permissions(ban_members=True)
    @decorators.sync()
    async def mute(self, ctx: commands.Context[Motoko], user: Member, minutes: int, *, reason: str | None):
    ...
    @commands.has_permissions(ban_members=True)
    @decorators.sync()
    async def unmute(self, ctx: commands.Context[Motoko], user: Member, *, reason: str | None):
